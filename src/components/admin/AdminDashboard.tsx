            ...
            <div>
              ...
              <nav className="p-3 space-y-1 overflow-y-auto max-h-[calc(100vh-170px)]">
                ...
                >
                  ...
                  <span className="text-[9px] px-1.5 py-0.5 rounded bg-zinc-800 text-zinc-400">All Photos</span>
                </button>
                ...
                >
                  ...
                  <span className="text-[10px] px-1.5 py-0.5 rounded bg-zinc-800 text-zinc-400">{categories.length}</span>
                </button>
          ...
          <div className="px-3 py-4">
            ...
            <nav className="space-y-1">
              ...
              >
                ...
                <span className="text-[9px] font-semibold px-2 py-0.5 rounded bg-zinc-800 text-zinc-400">Hero & About</span>
              </button>
              ...
              >
                ...
                <span className="text-[10px] font-mono px-2 py-0.5 rounded bg-zinc-800 text-zinc-400">{categories.length}</span>
              </button>
